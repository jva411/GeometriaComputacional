...
use crate::{lights::light::Light, objects::{grid::{axes::Axes, grid::Grid}, object::Object}, opengl::renderer::{ProgramType, Renderer}, utils::{camera::Camera, transform::Transformable}};
...
pub struct Scene {
  ...
  // pub squares: Vec<Rc<RefCell<dyn Object>>>,
...
impl Scene {
  ...
  pub fn add_object(&mut self, object: Rc<RefCell<dyn Object>>) {
    ...
    // if object.borrow().get_type() == ObjectType::Square {
    //   self.squares.push(object.clone());
    // }
  }
